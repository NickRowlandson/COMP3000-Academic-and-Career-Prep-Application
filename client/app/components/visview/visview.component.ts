...
this.items = new vis.DataSet();
 this.groups = new vis.DataSet();
  this.items.add(
            {id: 0, content: 'Math Lv1', start: '2017-07-05 8:00', end: '2017-07-05 11:00', group:0}
        )
    this.groups.add([
            {id: 0, content: 'Math'},
    ...
    {
        this.items.add(
            {id: 1, content: 'Math LV2', start: '2017-07-06 16:00', end: '2017-07-06 19:00',group:0}
        )
    ...
    add2(){
        this.items.add(
            {id: 2, content: 'Comm Lv1', start: '2017-07-07 14:00 ', end: '2017-07-07 15:00',group:3}
        )
          this.timeline.setData(this.items);
    }
    add3(){
        this.items.add(
            {id: 3, content: 'Chemistry LV1', start: '2017-07-08 17:00', end: '2017-07-0820:00',group:1}
        )
  this.timeline.setData(this.items);
